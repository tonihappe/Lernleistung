...
const char *monthl[] = {"January", "February", "March", "April", "May", "June",
...
char *create_fstring(int form, int prec, double loc, int type)
{
    ...
    double tmp;
    int m, d, y, h, mm, sec, day_of_year;
