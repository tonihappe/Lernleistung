...
class formula_to_process formula1;
    ...
    formula_c=formula1.execute_formula(graphto, loadto, gno, setno, 0,return_value);//complete ids and exectue formula
...
new_set_no=-1;
    ...
    for (n = 1; n < ncols; n++)
    {
        ...
        res = interpolate(mesh, yint[n], meshlen, x, y, len, method);
