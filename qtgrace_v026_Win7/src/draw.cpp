...
extern int collect_active;//to use the plot-routines to get the plot-lines
...
/*
 * is_inside_angle_range() checks if an angle a is inside two other angles (start-stop); please note, that multiples of 2Pi is allowed (i.e. the angle 0 is condidered to be inside [6-7])
 */
